...
var $pkg = $core.addPackage("Starter-Backend");
$pkg.transport = {"type":"amd","amdNamespace":"amber-starter"};

$core.addClass("StarterBackend", $globals.Object, "Starter-Backend");
$core.addMethod(
$core.method({
