...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        amberc: {
            ...
            all: {
                src: [
                    'src/Starter.st', 'src/Starter-Backend.st', // list all sources in dependency order
                    'src/Starter-Tests.st' // list all tests in dependency order
                ],
                amd_namespace: 'amber-starter',
